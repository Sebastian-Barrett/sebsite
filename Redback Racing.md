...
<div class="clearfix">
    ...
    <p class="leftfloat">My first ever 5-axis part was this steel mount for the HV battery. They are a great example of a 5-axis part because they required three setups on a 3-axis machine but only two on the 5-axis. They could also be machined from both sides, which means I could use shorter and more rigid tools on the 5-axis. They were welded to the chassis and used to bolt the HV battery to the spaceframe. </p>
</div>
<div class="clearfix">
